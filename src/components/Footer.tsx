    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-white font-poppins font-bold text-xl mb-4">
              Fund<span className="text-fundngn-gold">NGN</span>
            </h3>
            <p className="mb-4 text-sm">
              Decentralized crowdfunding with cNGN on Base. Supporting Nigerian innovation through community-powered funding.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="hover:text-white transition">Explore Campaigns</a></li>
              <li><a href="#" className="hover:text-white transition">Start a Campaign</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="hover:text-white transition">cNGN Token</a></li>
              <li><a href="#" className="hover:text-white transition">Base Network</a></li>
              <li><a href="#" className="hover:text-white transition">Community</a></li>
              <li><a href="#" className="hover:text-white transition">Creators Guide</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="hover:text-white transition">About FundNGN</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© 2025 FundNGN. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-sm hover:text-white transition">Legal</a>
          </div>
        </div>
      </div>
    </footer>
